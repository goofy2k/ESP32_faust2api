...
* **1**: `/Polyphonic/Voices/simpleSynth_Analog/attack`
* **2**: `/Polyphonic/Voices/simpleSynth_Analog/bend`
* **3**: `/Polyphonic/Voices/simpleSynth_Analog/decay`
* **4**: `/Polyphonic/Voices/simpleSynth_Analog/envMod`
* **5**: `/Polyphonic/Voices/simpleSynth_Analog/fc`
* **6**: `/Polyphonic/Voices/simpleSynth_Analog/freq`
* **7**: `/Polyphonic/Voices/simpleSynth_Analog/gain`
* **8**: `/Polyphonic/Voices/simpleSynth_Analog/gate`
* **9**: `/Polyphonic/Voices/simpleSynth_Analog/lfoFreq`
* **10**: `/Polyphonic/Voices/simpleSynth_Analog/modwheel`
* **11**: `/Polyphonic/Voices/simpleSynth_Analog/release`
* **12**: `/Polyphonic/Voices/simpleSynth_Analog/resonnance`
* **13**: `/Polyphonic/Voices/simpleSynth_Analog/sustain`
* **14**: `/Polyphonic/Voices/simpleSynth_Analog/tracking`
* **15**: `/Polyphonic/Voices/simpleSynth_Analog/waveform`

### Independent Voice

* **0**: `/simpleSynth_Analog/attack`
* **1**: `/simpleSynth_Analog/bend`
* **2**: `/simpleSynth_Analog/decay`
* **3**: `/simpleSynth_Analog/envMod`
* **4**: `/simpleSynth_Analog/fc`
* **5**: `/simpleSynth_Analog/freq`
* **6**: `/simpleSynth_Analog/gain`
* **7**: `/simpleSynth_Analog/gate`
* **8**: `/simpleSynth_Analog/lfoFreq`
* **9**: `/simpleSynth_Analog/modwheel`
* **10**: `/simpleSynth_Analog/release`
* **11**: `/simpleSynth_Analog/resonnance`
* **12**: `/simpleSynth_Analog/sustain`
* **13**: `/simpleSynth_Analog/tracking`
* **14**: `/simpleSynth_Analog/waveform`
