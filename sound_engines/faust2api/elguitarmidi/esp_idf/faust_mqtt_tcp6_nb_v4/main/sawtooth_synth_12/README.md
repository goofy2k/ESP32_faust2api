...
* **1**: `/Polyphonic/Voices/sawtooth_synth/Ctrl Value IN (Ctrl 1)`
* **2**: `/Polyphonic/Voices/sawtooth_synth/bend`
* **3**: `/Polyphonic/Voices/sawtooth_synth/freq`
* **4**: `/Polyphonic/Voices/sawtooth_synth/gain`
* **5**: `/Polyphonic/Voices/sawtooth_synth/gate`

### Independent Voice

* **0**: `/sawtooth_synth/Ctrl Value IN (Ctrl 1)`
* **1**: `/sawtooth_synth/bend`
* **2**: `/sawtooth_synth/freq`
* **3**: `/sawtooth_synth/gain`
* **4**: `/sawtooth_synth/gate`
