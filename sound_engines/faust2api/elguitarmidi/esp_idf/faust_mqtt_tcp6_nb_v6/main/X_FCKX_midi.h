#define FCKX_MIDICTRL 1

/************************** BEGIN fckx_midi.h **************************/
/************************************************************************
Very simple Midi implementation for use with DspFaust for ESP32.
This code is is based on esp32-midi.h, a FAUST Architecture File 
included in DspFaust.cpp generated with faust2api -esp32.

It was developed because until now attempts to use esp-midi.h failed because  
inclusion of it's jdksmidi dependency did not succeed. 
 ************************************************************************/

#if MQTT_MIDICTRL

#ifndef __FCKX_MIDI__
#define __FCKX_MIDI__
