...
* **1**: `/Polyphonic/Voices/WaveSynth_FX/A`
* **2**: `/Polyphonic/Voices/WaveSynth_FX/D`
* **3**: `/Polyphonic/Voices/WaveSynth_FX/R`
* **4**: `/Polyphonic/Voices/WaveSynth_FX/S`
* **5**: `/Polyphonic/Voices/WaveSynth_FX/bend`
* **6**: `/Polyphonic/Voices/WaveSynth_FX/freq`
* **7**: `/Polyphonic/Voices/WaveSynth_FX/gain`
* **8**: `/Polyphonic/Voices/WaveSynth_FX/gate`
* **9**: `/Polyphonic/Voices/WaveSynth_FX/lfoDepth`
* **10**: `/Polyphonic/Voices/WaveSynth_FX/lfoFreq`
* **11**: `/Polyphonic/Voices/WaveSynth_FX/waveTravel`
...
* **6**: `/WaveSynth_FX/gain`
* **7**: `/WaveSynth_FX/gate`
* **8**: `/WaveSynth_FX/lfoDepth`
* **9**: `/WaveSynth_FX/lfoFreq`
* **10**: `/WaveSynth_FX/waveTravel`
