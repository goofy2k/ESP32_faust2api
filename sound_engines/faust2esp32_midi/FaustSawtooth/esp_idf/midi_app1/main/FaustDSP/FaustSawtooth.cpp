// Options :
#define NVOICES 2
#define MIDICTRL true
#define TTGO_TAUDIO true
/* ------------------------------------------------------------
name: "FaustSawtooth"
...
void FaustSawtooth::setParamValue(const string& path, float value)
{
    fUI->setParamValue(path, value);
}

float FaustSawtooth::getParamValue(const string& path)
{
